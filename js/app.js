...
function cargarListadoEventos()
{
    ...
    //muestra los cursos de local storage en el dom
    document.addEventListener('DOMContentLoaded',()=>
    {
        arrayMeterProductosalcarro=JSON.parse(localStorage.getItem('carritocompras'))||[];
        carritoHTML();
...
{
    localStorage.setItem('carritocompras',JSON.stringify(arrayMeterProductosalcarro));
}
